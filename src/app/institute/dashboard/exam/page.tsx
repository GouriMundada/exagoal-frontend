...
export default function ExamPage() {
  ...
  const [selectedSubject, setSelectedSubject] = useState("Advanced Calculus & Differential Equations");
  ...
  const handleGenerateExam = async (e: React.FormEvent) => {
    ...
    setGenerating(true);
    setGenStatus(`Generating ${selectedSubject} (${selectedSyllabusSet}) using indexed context & AI (this may take 15–45 seconds)...`);
          ...
          {activeStep === 1 && (
            <div className="grid grid-cols-1 lg:grid-cols-5 gap-6">
              ...
              <div className="lg:col-span-3 bg-white rounded-none border-2 border-slate-900 p-6 space-y-6 shadow-[4px_4px_0_0_#0f172a]">
                ...
                <div className="p-4 bg-blue-50 border border-slate-900 rounded-none space-y-2">
                  <div className="flex items-center justify-between gap-4">
                    <span className="text-xs font-bold text-blue-800">Selected Subject</span>
                    <span className="text-xs font-semibold text-blue-700 text-right">{selectedSubject}</span>
                  </div>
                  <div className="flex items-center justify-between gap-4">
                    <span className="text-xs font-bold text-blue-800">Selected Syllabus</span>
                    <span className="text-xs font-semibold text-blue-700">{selectedSyllabusSet}</span>
                  </div>
                </div>
                ...
                <div className="flex items-center justify-end pt-2 border-t-2 border-slate-900">
                  <button
                    ...
                    className="flex items-center gap-1.5 px-5 py-2.5 bg-blue-600 hover:bg-blue-700 disabled:opacity-50 text-white rounded-none text-xs font-bold shadow-[3px_3px_0_0_#0f172a] transition-all"
                  >
            ...
            <div className="grid grid-cols-1 lg:grid-cols-5 gap-6">
              ...
              <div className="lg:col-span-3 bg-white rounded-none border-2 border-slate-900 p-6 space-y-5 shadow-[4px_4px_0_0_#0f172a]">
                ...
                <form onSubmit={handleGenerateExam} className="space-y-4">
                  ...
                  {/* Status Banner */}
                  {genStatus && (
                    <div className="p-3.5 bg-blue-50 border border-slate-900 rounded-none flex items-start gap-2.5 text-xs text-blue-900">
                  ...
                  <div className="flex items-center justify-between pt-2 border-t-2 border-slate-900">
                    ...
                    <button
                      ...
                      className="flex items-center gap-2 px-6 py-3 bg-blue-600 hover:bg-blue-700 disabled:opacity-50 text-white rounded-none text-sm font-bold shadow-[5px_5px_0_0_#0f172a] shadow-blue-200 transition-all"
                    >
                      {generating ? (
                        <>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
          ...
          <div className="space-y-4">
            <div className="bg-white rounded-none border-2 border-slate-900 p-5 space-y-2 shadow-[4px_4px_0_0_#0f172a]">
              ...
              <p className="text-xs text-gray-500 leading-relaxed">
                ExaGo indexes context documents and syllabus data into a high-dimensional FAISS embedding vector space. During question generation, relevant curriculum objectives and problem sets are semantically retrieved to guide the LLM.
              </p>
            </div>
